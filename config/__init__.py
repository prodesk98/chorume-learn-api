...
class settings(BaseModel):
    ...
    LEARN_VOICE_ENABLED: Optional[bool] = (getenv("LEARN_VOICE_ENABLED", "true") == "true")
    ELEVENLABS_API_KEY: Optional[str] = getenv("ELEVENLABS_API_KEY", None)
    LEARN_VOICE_ID: Optional[str] = getenv("LEARN_VOICE_ID", None)
    MILLION_SHOW_VOICE_ID: Optional[str] = getenv("MILLION_SHOW_VOICE_ID", None)
    MILLION_SHOW_VOICE_ENABLED: Optional[bool] = (getenv("MILLION_SHOW_VOICE_ENABLED", "true") == "true")
